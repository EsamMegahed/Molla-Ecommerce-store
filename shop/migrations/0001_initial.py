    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avalble_color', models.ManyToManyField(to='shop.productcolor')),
                ('avalble_sizes', models.ManyToManyField(to='shop.productsize')),
                ('product_Brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.productbrand')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
